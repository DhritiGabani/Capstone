...
DATA_DIR = os.path.join(SCRIPT_DIR, "..", "data_arami")
...
def load_signals_from_txt(filepath):
    ...
    cols_needed = ["PacketCounter", "Acc_X", "Acc_Y", "Acc_Z", "Gyr_X", "Gyr_Y", "Gyr_Z"]
    ...
    for col in cols_needed:
        try:
            ...
            raise ValueError(f"Column '{col}' not found in {filepath}. Header: {header}")
        ...
        for date_folder in os.listdir(subject_path):
            ...
            for exercise in ["Ankle Rotation", "Calf Raises", "Calibration", "Heel Walk", "Knee to Wall"]:
                ...
                for file in os.listdir(exercise_path):
                    ...
                    set_label = extract_set(exercise, file)
